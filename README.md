# `GIAC_jll.jl` (v2.0.2+0)

[![deps](https://juliahub.com/docs/GIAC_jll/deps.svg)](https://juliahub.com/ui/Packages/General/GIAC_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/e612eee573c15f4d3a1cd4484d4827fdb32ee4b4/G/GIAC/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/JuliaGiac/giac.git (revision: `42d064e3ea3525b9e7a6fa3ffd3caeb99e2bea3a`)
...
* [`PARI_jll`](https://github.com/JuliaBinaryWrappers/PARI_jll.jl)
